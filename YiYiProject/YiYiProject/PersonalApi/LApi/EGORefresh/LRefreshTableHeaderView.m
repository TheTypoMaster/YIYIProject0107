...
//        UILabel *label2;
//		
//		label2 = [[UILabel alloc] initWithFrame:CGRectMake(0.0f, frame.size.height - 42.0f, frame.size.width, 20.0f)];
...
//        
//        AMPActivityIndicator *view = [[AMPActivityIndicator alloc]initWithFrame:CGRectMake(0, label.top, 40, 40)];
...
//        [view startAnimating];
//        
//        view.center = CGPointMake(DEVICE_WIDTH/4.f, label.bottom);
//        
////		_activityView = view;
//        //		[view release];
//        
...
//        [view startAnimating];
        ...
        //更新状态
        UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(view.right, 10, 80, 15.0f)];
        label2.autoresizingMask = UIViewAutoresizingFlexibleWidth;
...
- (void)refreshLastUpdatedDate {
	...
	if (_delegate && [_delegate respondsToSelector:@selector(egoRefreshTableDataSourceLastUpdated:)]) {
		...
		_lastUpdatedLabel.text = [NSString stringWithFormat:@"%@", [LTools showTimeWithTimestamp:[LTools timechangeToDateline]]];
