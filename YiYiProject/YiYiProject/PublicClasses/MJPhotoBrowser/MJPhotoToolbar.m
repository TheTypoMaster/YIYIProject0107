...
//        [MBProgressHUD showSuccess:@"" toView:nil];
        ...
        [LTools showMBProgressWithText:@"保存失败" addToView:[UIApplication sharedApplication].keyWindow];
...
//        [MBProgressHUD showSuccess:@"" toView:nil];
        ...
        [LTools showMBProgressWithText:@"成功保存到相册" addToView:[UIApplication sharedApplication].keyWindow];
    }
}
